...
export const bounceTopEntrance: Keyframe[] = [
  {
    offset: 0,
    easing: easeOutCubic,
    transform: "translate3d(0px, -400px, 0px) scale3d(1, 2, 1)",
    opacity: "0",
  },
  {
    offset: 0.6,
    easing: easeOutCubic,
    transform: "translate3d(0px, 50px, 0px) scale3d(1, 0.75, 1)",
    opacity: "0.8",
  },
  {
    offset: 0.75,
...
export const bounceLeftEntrance: Keyframe[] = [
  {
    offset: 0,
    easing: easeOutCubic,
    transform: "translate3d(-400px, 0px, 0px) scale3d(2, 1, 1)",
    opacity: "0",
  },
  {
    offset: 0.6,
    easing: easeOutCubic,
    transform: "translate3d(50px, 0px, 0px) scale3d(0.75, 1, 1)",
    opacity: "0.8",
  },
  {
    offset: 0.75,
